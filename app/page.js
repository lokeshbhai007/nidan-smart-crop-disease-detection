          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Instantly identify crop diseases through AI image analysis and
                get expert guidance. Save your harvest, reduce losses, and
                maximize your yield.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Simple three-step process to identify and treat crop diseases
              effectively with AI-powered precision
            </p>
          </motion.div>
            ...
            {[
              ...
              >
                <div className="bg-white border-2 border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 h-full">
                  {/* Icon with Gradient */}
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${item.gradient} rounded-xl mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive AI-powered tools designed specifically for farmers
              to detect, prevent, and treat crop diseases
            </p>
          </motion.div>
            ...
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl p-8 lg:p-12 text-white shadow-2xl">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-lg text-green-100 mb-8">
                  Join thousands of farmers who are already using AI to detect
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                ...
                expert guidance. Protecting harvests and building sustainable
                agriculture.
              </p>
            </div>
